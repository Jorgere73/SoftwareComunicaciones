...
public class ListadoIncidencias extends JFrame {
	...
	public ListadoIncidencias() {
		...
		JLabel lblListaDeSensores = new JLabel("Lista de incidencias de la cuenta");
		...
		btnVolver.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) 
			{
				...
				GlobalInstances.listaIncidencias.setVisible(false);
			}
		});
